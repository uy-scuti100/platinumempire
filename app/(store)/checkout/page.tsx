...
// 	() => import("./_components/upsell-products"),
// 	{ ssr: false }
// );
...
// 		image: item.image,
// 		inStock: item.inStock ?? false, // Ensure `inStock` is always a boolean
// 		name: item.name,
// 		price: item.price,
// 		quantity: item.quantity,

// 		selectedColor: item.selectedColor || "", // Provide a default empty string
// 		selectedSize: item.selectedSize || "", // Provide a default empty string
// 		slug: item.slug,
...
// 									cart={{ items: transformedCartItems }}
// 								/>
// 							)}
// 						</div>
// 					</div>
